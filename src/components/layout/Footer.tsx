...
const Footer = () => {
  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 min-h-[100px]">
      ...
      <footer
        ...
        style={{
          background: "linear-gradient(0deg, rgb(0, 0, 0) 0%, rgb(0 0 0) 50%, rgb(0 0 0 / 0%) 100%)"
        }}
      >
        ...
        {!isLoggedIn && (
        <div className="relative py-8 sm:py-10 md:py-12 mb-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-2xl sm:text-3xl font-boldtext-white">Passly</span>
                </div>
                {/* Tagline */}
              ...
              <div className="space-y-8">
                ...
                <div className="flex gap-4 sm:gap-6">
                  {/* Twitter/X */}
                  <a href="#" className="w-10 h-10 bg-white border border-white rounded-lg flex items-center justify-center hover:bg-gray-800 transition-colors duration-200">
